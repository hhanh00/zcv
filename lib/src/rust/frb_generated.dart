...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -16072374;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<Context> crateApiContextNew({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Context> crateApiContextNew({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiContextNewConstMeta,
        argValues: [dbPath, lwdUrl, electionUrl],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiContextNewConstMeta => const TaskConstMeta(
    debugName: "Context_new",
    argNames: ["dbPath", "lwdUrl", "electionUrl"],
  );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(hash, serializer);
          sse_encode_list_prim_u_32_loose(idAccounts, serializer);
          sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerContext(
            context,
            serializer,
          );
        ...
        argValues: [hash, idAccounts, context],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta get kCrateApiSimpleScanBallotsConstMeta => const TaskConstMeta(
    ...
    argNames: ["hash", "idAccounts", "context"],
  );
